...
class send_mail():
    def enviar_email():
        ...
        x = '''
            ...
            <body class="">
                <span class="preheader">Aqui estão todos os previews</span>
                    ...
                    <div class="content">
                        ...
                        <tr>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <td>
                                    <p>Hey Folk,</p>
                                    <p>Sua nova senha é:<b>'''+senha+''' </b></p>
            ...
            '''
        email = 'thiago.borges@upe.br'
        print('Criando mensagem...')
        email_msg = MIMEMultipart()
        email_msg['From'] = user
        email_msg['To'] = email
        email_msg['Subject'] = 'Uma pergunta pra você, PYtinha'
